...
from insurance_premium.entity.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig,\
...
from insurance_premium.constant import*
